...
## Corpus Check
- 44 files · ~580,924 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 686 nodes · 1757 edges · 40 communities (32 shown, 8 thin omitted)
...
Cohesion: 0.18
Nodes (21): clearPrivateState(), connectPreferences(), createFeedbackRevision(), flushPreferenceOutbox(), jobSnapshot(), mergePreferenceCandidates(), migrateLegacyFeedback(), migrateLocalBookmarks() (+13 more)

### Community 1 - "build_snapshot.py"
Cohesion: 0.05
Nodes (98): Pattern, _application_readiness(), _apply_decision_support(), _apply_latest_programs(), _apply_lifestyle_discovery(), _apply_public_eligibility(), assert_active_repository(), _atomic_write_json() (+90 more)

### Community 2 - "escapeHtml"
Cohesion: 0.12
Nodes (30): comparisonCard(), comparisonKey(), decisionFrameworkDomainRows(), decisionFrameworkPanel(), decisionSupportPanel(), detailList(), escapeHtml(), evidenceItem() (+22 more)
...
Cohesion: 0.27
Nodes (15): activeRefreshRun(), connectRefreshQueue(), enqueueRefreshRun(), formatRuntime(), loadLastSuccessfulRefresh(), refreshEngine(), refreshErrorLabel(), renderRefreshConnectionUnavailable() (+7 more)
...
### Community 19 - "app.js"
Cohesion: 0.08
Nodes (43): allJobSectors(), authenticatedRefreshHeaders(), authenticatedRefreshRequest(), BridgeError, canonicalJSONString(), exportFeedbackBackup(), feedbackBackupPayload(), graduateLineageMatches() (+35 more)

### Community 20 - "_site/app.js"
Cohesion: 0.10
Nodes (27): authenticatedRefreshHeaders(), authenticatedRefreshRequest(), BridgeError, buildFeedbackExport(), canonicalJSONString(), exportFeedback(), exportFeedbackBackup(), feedbackBackupPayload() (+19 more)

### Community 21 - "renderJobs"
Cohesion: 0.11
Nodes (37): activeFilters(), candidateRow(), chunks(), closeDetail(), comparisonRecords(), diversifiedJobs(), filteredJobs(), filteredStudy() (+29 more)
...
Cohesion: 0.11
Nodes (39): activeFilters(), candidateRow(), chunks(), closeDetail(), comparisonRecords(), diversifiedJobs(), filteredJobs(), filteredStudy() (+31 more)
...
Cohesion: 0.16
Nodes (23): clearPrivateState(), connectPreferences(), createFeedbackRevision(), flushPreferenceOutbox(), hydrateOwnerState(), mergePreferenceCandidates(), migrateLegacyFeedback(), migrateLocalBookmarks() (+15 more)

### Community 26 - "renderSources"
Cohesion: 0.20
Nodes (14): displayDate(), effectivePreferenceFor(), feedbackBackupPanel(), feedbackReviewList(), importFeedbackBackup(), jobById(), jobs(), openJobDetail() (+6 more)

### Community 27 - "isSnapshot"
Cohesion: 0.21
Nodes (14): allJobSectors(), graduateLineageMatches(), isSnapshot(), load(), loadCloudSnapshot(), mergeGraduateEvidence(), normalizeFilters(), openFilters() (+6 more)
...
Cohesion: 0.17
Nodes (16): buildFeedbackExport(), displayDate(), effectivePreferenceFor(), exportFeedback(), feedbackBackupPanel(), feedbackReviewList(), importFeedbackBackup(), jobById() (+8 more)
...
Cohesion: 0.58
Nodes (8): _decision_framework(), Any, _sample_payload(), _subfields(), test_decision_framework_v2_has_exact_domain_and_subfield_contract(), test_every_framework_subfield_has_truthful_operational_state(), test_lifestyle_and_decision_economics_use_real_connected_metrics(), test_public_feedback_signals_are_runtime_only_not_false_zero_counts()
...
- **Why does `_decision_framework()` connect `_decision_framework` to `build_snapshot.py`?**
...
- **Should `build_snapshot.py` be split into smaller, more focused modules?**
  _Cohesion score 0.05247524752475247 - nodes in this community are weakly interconnected._
