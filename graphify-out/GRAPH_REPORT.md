...
## Corpus Check
- 18 files · ~216,962 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 173 nodes · 398 edges · 14 communities (10 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd3d5667`
...
Cohesion: 0.14
Nodes (35): activeFilters(), candidateRow(), chunks(), detailList(), diversifiedJobs(), escapeHtml(), evidenceItem(), filteredJobs() (+27 more)
...
Cohesion: 0.18
Nodes (17): closeDetail(), connectPreferences(), displayDate(), feedbackReviewList(), go(), migrateLocalBookmarks(), openFeedback(), persistPreferences() (+9 more)

### Community 5 - "Bridge Communication"
Cohesion: 0.14
Nodes (32): allJobSectors(), authenticatedRefreshHeaders(), BridgeError, bridgeRequest(), bridgeUrl(), connectBridge(), formatRuntime(), isSnapshot() (+24 more)
